...
hi('StatusLine',   { fg = 'White', bg = '#005577', reverse = false, bold = false,       cterm = { reverse = false, bold = true }})
hi('StatusLineNC', { fg = 'White', bg = '#5f676a', reverse = false,                    cterm = { reverse = false } })
hi('TabLineFill',  { cterm = { reverse = true } })
hi('TabLineSel',   { bold = false, bg = '#005577',       cterm = { bold = true } })
...
hi('@lsp.type.variable',      { link = 'Identifier' })
  ...
  hi('ColorColumn',  { bg = '#005577',                            ctermbg = 'DarkRed' })
  ...
  hi('PmenuSel',     { bg = '#005577',                           ctermfg = 'DarkGrey', ctermbg = 'Black' })
  ...
  hi('Visual',       { fg = 'white', bg = '#005577',              ctermfg = 'Black', ctermbg = 'Grey' })
