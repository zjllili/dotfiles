...
if [ ! $UID -eq 0 ]; then
    if [ -n "$SSH_CONNECTION" ]; then
        PS1='\[\033[30;105m\]\u@\h\[\033[00;00m\] \[\033[01;40m\]\W$(__git_ps1 " %s")\[\033[00;00m\] \$ '
    else
        PS1='\[\033[00;106m\]\u@\h\[\033[00;00m\] \[\033[01;40m\]\W$(__git_ps1 " %s")\[\033[00;00m\] \$ '
    fi
else
        PS1='\[\033[30;101m\]\u@\h\[\033[00;00m\] \[\033[01;40m\]\W$(__git_ps1 " %s")\[\033[00;00m\] \$ '
fi
